...
type Specification = readonly [string, string];
...
export default function PrismDetailPage({ title, description, image, specifications }: Props) {
  return (
    <main>
      <SiteHeader />
      <section className="compact-product-detail section">
        <div className="breadcrumb"><a href="/">Home</a><span>/</span><a href="/products">Products</a><span>/</span><a href="/products/optical-prisms">Optical Prisms</a><span>/</span><b>{title}</b></div>
