...
type Props = { title:string; description:string; image:string; specifications:readonly (readonly [string,string])[] };

export default function BeamShapingDetailPage({ title, description, image, specifications }: Props) {
  return <main>
    <SiteHeader />
    <section className="compact-product-detail section">
      <div className="breadcrumb"><a href="/">Home</a><span>/</span><a href="/products">Products</a><span>/</span><a href="/products/beam-shaping-optics">Beam Shaping Optics</a><span>/</span><b>{title}</b></div>
