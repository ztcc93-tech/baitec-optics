...
export default function MirrorDetailPage({ title, description, image, specifications }: Props) {
  return <main>
    <SiteHeader />
    <section className="compact-product-detail section">
      <div className="breadcrumb"><a href="/">Home</a><span>/</span><a href="/products">Products</a><span>/</span><a href="/products/optical-mirrors">Optical Mirrors</a><span>/</span><b>{title}</b></div>
