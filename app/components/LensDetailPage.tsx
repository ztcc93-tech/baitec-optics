...
export default function LensDetailPage({ title, description, image, specifications }: Props) {
  return <main>
    <SiteHeader />
    <section className="compact-product-detail section">
      <div className="breadcrumb"><a href="/">Home</a><span>/</span><a href="/products">Products</a><span>/</span><a href="/products/optical-lenses">Optical Lenses</a><span>/</span><b>{title}</b></div>
