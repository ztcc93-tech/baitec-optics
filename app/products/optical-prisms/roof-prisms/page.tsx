...
export default function Page() { return <PrismDetailPage title="Roof Prisms" description="Precision roof prisms manufactured to customer specifications." image="/products/prisms/roof.webp" specifications={specifications} />; }
