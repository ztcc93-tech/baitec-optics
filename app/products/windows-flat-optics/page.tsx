...
const windowFamilies = [
  {
    ...
    href: "/products/windows-flat-optics/round-windows",
  },
  {
    number: "02",
    ...
    href: "/products/windows-flat-optics/rectangular-windows",
  },
  {
    number: "03",
    name: "Wedge Windows",
    ...
    href: "/products/windows-flat-optics/wedge-windows",
  },
  {
    number: "04",
    ...
    href: "/products/windows-flat-optics/high-precision-optical-flats",
  },
  {
    number: "05",
    ...
    href: "/products/windows-flat-optics/infrared-windows",
  },
];
  ...
  return (
    <main>
      ...
      <section className="lens-cta section">
        ...
        <div><p>Send us your dimensions, substrate, flatness, surface quality, wavelength range and coating requirements.</p><a className="button" href="mailto:sales@baitecoptics.com">sales@baitecoptics.com <ArrowUpRight /></a></div>
      </section>
