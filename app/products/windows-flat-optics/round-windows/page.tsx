...
export default function Page() { return <WindowDetailPage title="Round Windows" description="Precision round optical windows manufactured to customer specifications." image="/products/windows/round-window.webp" specifications={specifications} />; }
