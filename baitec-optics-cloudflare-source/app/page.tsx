...
const products = [
  { number: "01", name: "Optical Lenses", summary: "Precision imaging and beam control", items: ["Plano-Convex", "Plano-Concave", "Bi-Convex", "Bi-Concave", "Meniscus", "Optical Domes", "Cemented"], mark: "◒", href: "/products/optical-lenses" },
  { number: "02", name: "Optical Prisms", summary: "Beam steering, rotation and splitting", items: ["Right-Angle Prisms", "Penta Prisms", "Dove Prisms", "Corner Cube Prisms", "Beamsplitter Prisms", "Roof Prisms", "Cube Prisms", "Linear Prisms"], mark: "△" },
  { number: "03", name: "Windows & Flat Optics", summary: "Protection, transmission and reference flats", items: ["Round Windows", "Rectangular Windows", "Wedge Windows", "High-Precision Optical Flats", "Infrared Windows"], mark: "▣" },
  { number: "04", name: "Optical Mirrors", summary: "Reflective optics for focusing and steering", items: ["Spherical Mirrors", "Flat Mirrors"], mark: "◐" },
  { number: "05", name: "Beam Shaping Optics", summary: "Purpose-built profiles for laser and illumination", items: ["Powell Lenses", "Optical Integrators", "Integrator Arrays"], mark: "≈" },
  { number: "06", name: "Optical Filters", summary: "Precise spectral selection and attenuation", items: [], mark: "◎" },
  { number: "07", name: "Infrared Optics", summary: "Components engineered for infrared applications", items: ["ZnSe", "ZnS", "Germanium", "Silicon", "CaF₂", "MgF₂", "BaF₂", "Sapphire"], mark: "◇" },
  { number: "08", name: "OEM Optical Solution", summary: "Engineering and production support for custom optics", items: ["Optical Design Services", "Optical Coating", "Custom-Shaped Optics", "Crystal Material Processing"], mark: "✦" },
];
    ...
    <main>
      ...
      <section className="products section" id="products">
        ...
        <div className="product-grid">
          {products.map((product) => (
            <a className="product-card" href={product.href || "/products"} key={product.name}>
              ...
              <div className="product-content">
                <div className="product-title"><h3>{product.name}</h3><p>{product.summary}</p></div>
                {product.items.length > 0 && <ul>{product.items.map((item) => <li key={item}>{item}</li>)}</ul>}
      ...
      <section className="contact section" id="contact">
        ...
        <div>
          ...
          <a className="button button-light" href="mailto:baitecoptics@gmail.com">baitecoptics@gmail.com <ArrowUpRight /></a>
        </div>
      </section>
